...
<body>
    <div class="container">
        <h1><b>INSERT THIRD SECTION</b></h1>
        <form action="controller.php" method="POST" enctype="multipart/form-data">
            
             <div class="form-group">
                <label>Profile Image </label>
                <input type="file" name="txtProfile" class="form-control-file" required>
            </div>
            ...
            <button type="submit" name="save_thirdSection" class="btn btn-success">Save Portfolio</button>
        </form>
    </div>
</body>
</html>