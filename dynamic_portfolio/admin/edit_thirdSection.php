...
<body>
    <div class="container">
        <h1>Edit Third Section</h1>
        <form action="controller.php" method="POST" enctype="multipart/form-data">
            <?php 
                getTableById($_GET['id']);
            ?>
            <button type="submit" class="btn btn-primary" name="update_thirdSection">Update Portfolio</button>
        </form>
    </div>
</body>
</html>
...
<?php
    function getTableById($recno) {
        ...
        $sql = "SELECT * FROM thirdSection WHERE id='$recno'";
            ...
            while ($row = $result->fetch_assoc()) {
                echo "
                    ...
                    <div class='form-group'>
                        ...
                        <br>
                        <img src='uploads/".$row['profile']."' width='300'>
                        <input type='hidden' name='txtold_profile' value ='".$row['profile']."'>
                        <div class='form-group'>
