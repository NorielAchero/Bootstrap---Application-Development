...
<body>
    <div class="container">
        ...
        <form action="controller.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Nav1: </label>
                <input type="text" name="txtNav1" class="form-control">
            </div>

            <div class="form-group">
                <label>Nav2: </label>
                <input type="text" name="txtNav2" class="form-control">
            </div>

            <div class="form-group">
                <label>Nav3: </label>
                <input type="text" name="txtNav3" class="form-control">
            </div>

            <div class="form-group">
                <label>Nav4: </label>
                <input type="text" name="txtNav4" class="form-control">
            </div>

            <button type="submit" name="save_nav" class="btn btn-success">Save Portfolio</button>
        </form>
    </div>
</body>
</html>