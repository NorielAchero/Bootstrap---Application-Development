        ...
        <div class = "row">
                ...
                <div class = "modal fade" id="m1">
                    <div class = "modal-dialog">
                        <div class = "modal-content">
                            <div class = "modal-header">JDM 1</div>
                            <div class = "modal-body">
                                <img src="image/1.jpg" class = "img-thumbnail">
                            </div>
                            <div class = "modal-footer">Skyline</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class = "col-md-4"> 
                ...
                <div class = "modal fade" id="m2">
                    <div class = "modal-dialog">
                        <div class = "modal-content">
                            <div class = "modal-header">JDM 2</div>
                            <div class = "modal-body">
                                <img src="image/2.jpg" class = "img-thumbnail">
                            </div>
                            <div class = "modal-footer">TRUENO</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class = "col-md-4"> 
                ...
                <div class = "modal fade" id="m3">
                    <div class = "modal-dialog">
                        <div class = "modal-content">
                            <div class = "modal-header">JDM 3</div>
                            <div class = "modal-body">
                                <img src="image/3.jpg" class = "img-thumbnail">
                            </div>
                            <div class = "modal-footer">86</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class = "col-md-4"> 
                ...
                <div class = "modal fade" id="m4">
                    <div class = "modal-dialog">
                        <div class = "modal-content">
                            <div class = "modal-header">JDM 4</div>
                            <div class = "modal-body">
                                <img src="image/4.jpg" class = "img-thumbnail">
                            </div>
                            <div class = "modal-footer">NSX</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class = "col-md-4"> 
                ...
                <div class = "modal fade" id="m5">
                    <div class = "modal-dialog">
                        <div class = "modal-content">
                            <div class = "modal-header">JDM 5</div>
                            <div class = "modal-body">
                                <img src="image/5.jpg" class = "img-thumbnail">
                            </div>
                            <div class = "modal-footer">S2000</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class = "col-md-4"> 
                ...
                <div class = "modal fade" id="m6">
                    <div class = "modal-dialog">
                        <div class = "modal-content">
                            <div class = "modal-header">JDM 6</div>
                            <div class = "modal-body">
                                <img src="image/6.jpg" class = "img-thumbnail">
                            </div>
                            <div class = "modal-footer">R34</div>
                        </div>
                    </div>
                </div>
            </div>
